...
QUnit.test('RFC 6265 - character not allowed in the cookie-value " "', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=%20', 'whitespace is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-value ","', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=%2C', 'comma is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-value ";"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=%3B', 'semicolon is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-value "\\"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=%5C', 'backslash is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - characters not allowed in the cookie-value should be replaced globally', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=%3B%3B', 'should replace multiple not allowed characters');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value "#"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=#', 'sharp is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value "$"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=$', 'dollar sign is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value "%"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=%25', 'percent is allowed, but need to be escaped');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value "&"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=&', 'ampersand is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value "+"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=+', 'plus is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value ":"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=:', 'colon is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value "<"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=<', 'less-than is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value ">"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=>', 'greater-than is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value "="', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c==', 'equal sign is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value "/"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=/', 'slash is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value "?"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=?', 'question mark is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value "@"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=@', 'at is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value "["', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=[', 'opening square bracket is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value "]"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=]', 'closing square bracket is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value "^"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=^', 'caret is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value "`"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=`', 'grave accent is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value "{"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c={', 'opening curly bracket is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value "}"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=}', 'closing curly bracket is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-value "|"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=|', 'pipe is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - characters allowed in the cookie-value should globally not be encoded', function (assert) {
	...
	.setCookie('c', '{{')
	.then(function (decodedValue, plainValue) {
		assert.strictEqual(plainValue, 'calibre_c={{', 'should not encode all the character occurrences');
	});
});
...
QUnit.test('cookie-value - 2 bytes character (ã)', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=%C3%A3', 'should encode the ã character');
	});
});
...
QUnit.test('cookie-value - 3 bytes character (₯)', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=%E2%82%AF', 'should encode the ₯ character');
	});
});
...
QUnit.test('cookie-value - 4 bytes character (𩸽)', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_c=%F0%A9%B8%BD', 'should encode the 𩸽 character');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name "("', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%28=v', 'opening parens is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name ")"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%29=v', 'closing parens is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - should replace parens globally', function (assert) {
	...
	.setCookie('(())', 'v')
	.then(function (decodedValue, plainValue) {
		assert.strictEqual(plainValue, 'calibre_%28%28%29%29=v', 'encode with global replace');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name "<"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%3C=v', 'less-than is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name ">"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%3E=v', 'greater-than is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name "@"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%40=v', 'at is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name ","', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%2C=v', 'comma is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name ";"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%3B=v', 'semicolon is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name ":"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%3A=v', 'colon is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name "\\"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%5C=v', 'backslash is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name "\""', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%22=v', 'double quote is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name "/"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%2F=v', 'slash is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name "["', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%5B=v', 'opening square brackets is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name "]"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%5D=v', 'closing square brackets is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name "?"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%3F=v', 'question mark is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name "="', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%3D=v', 'equal sign is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name "{"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%7B=v', 'opening curly brackets is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name "}"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%7D=v', 'closing curly brackets is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name "\\t"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%09=v', 'horizontal tab is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character not allowed in the cookie-name " "', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%20=v', 'whitespace is not allowed, need to encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-name "#"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_#=v', 'sharp is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-name "$"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_$=v', 'dollar sign is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in cookie-name "%"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%25=v', 'percent is allowed, but need to be escaped');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-name "&"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_&=v', 'ampersand is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-name "+"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_+=v', 'plus is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-name "^"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_^=v', 'caret is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-name "`"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_`=v', 'grave accent is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - character allowed in the cookie-name "|"', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_|=v', 'pipe is allowed, should not encode');
	});
});
...
QUnit.test('RFC 6265 - characters allowed in the cookie-name should globally not be encoded', function (assert) {
	...
	.setCookie('||', 'v')
	.then(function (decodedValue, plainValue) {
		assert.strictEqual(plainValue, 'calibre_||=v', 'should not encode all character occurrences');
	});
});
...
QUnit.test('cookie-name - 2 bytes characters', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%C3%A3=v', 'should encode the ã character');
	});
});
...
QUnit.test('cookie-name - 3 bytes characters', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%E2%82%AF=v', 'should encode the ₯ character');
	});
});
...
QUnit.test('cookie-name - 4 bytes characters', function (assert) {
	...
	.then(function (decodedValue, plainValue) {
		...
		assert.strictEqual(plainValue, 'calibre_%F0%A9%B8%BD=v', 'should encode the 𩸽 character');
	});
});
